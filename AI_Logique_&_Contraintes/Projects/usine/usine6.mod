...
minimize
   // minimiser la difference équivaut à minimiser endProjet et maximiser le debut de la tâche P
   endProjet - startOf(itv_taches["P"]) / sumDuree;
